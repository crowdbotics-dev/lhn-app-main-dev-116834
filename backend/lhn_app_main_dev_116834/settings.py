"""
Django settings for lhn_app_main_dev_116834 project.
...
ROOT_URLCONF = 'lhn_app_main_dev_116834.urls'
...
WSGI_APPLICATION = 'lhn_app_main_dev_116834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lhn_app_main_dev_116834 API",
    "DESCRIPTION": "API documentation for lhn_app_main_dev_116834 App",
    "VERSION": "v1",
}
